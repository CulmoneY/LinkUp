...
public class AppBuilder {
    ...
    private final AddPersonalEventInputBoundary addPersonalEventInteractor = new AddPersonalEventInteractor(userGroupDAO, addPersonalEventOutputBoundary, eventFactory);
