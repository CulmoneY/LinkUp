...
1. [LinkUp](#linkup)  
   1.1 [Project Overview](#project-overview)  
      ...
      - [Why the Project Was Made](#why-the-project-was-made)  
      - [What Problem This Project Solves](#what-problem-this-project-solves)  
      - [Is This Useful for Users?](#is-this-useful-for-users)  

2. [Features of LinkUp](#features-of-linkup)  
   2.1 [Create Account](#create-account)  
   2.2 [Login](#login)  
   2.3 [Change Language](#change-language)  
   2.4 [Add Friends](#add-friends)  
   2.5 [Remove Friends](#remove-friends)  
   2.6 [Create Group](#create-group)  
   2.7 [Add Users to Group](#add-users-to-group)  
   2.8 [Remove Users from Group](#remove-users-from-group)  
   2.9 [Select Group](#select-group)  
   2.10 [Chat/Send Messages](#chat-send-messages)  
   2.11 [Add Events](#add-events)  
   2.12 [Remove Events](#remove-events)  
   2.13 [Select "LinkUp" Time in Group](#select-linkup-time-in-group)  
   2.14 [Export Events to Calendar (.ics) File](#export-events-to-calendar-ics-file)  
...
7. [How to Give Feedback on LinkUp](#how-to-give-feedback-on-linkup)  

8. [How to Contribute to the LinkUp Project](#how-to-contribute-to-the-linkup-project)  
   8.1 [Instructions for Making a Fork of the Project](#instructions-for-making-a-fork-of-the-project)  
   8.2 [Guidelines for Creating a Good Merge Request](#guidelines-for-creating-a-good-merge-request)  
   8.3 [Protocols for Reviewing Contributions and Merging](#protocols-for-reviewing-contributions-and-merging)  

9. [Credits: Team Members](#credits-team-members)  
...
3. **Configure Application Properties**
   ...
   - Update the following placeholders with your actual credentials:
     ...
     ```
     mongodb.connectionString=mongodb+srv://YOUR_USERNAME:YOUR_PASSWORD@linkup.szhpc.mongodb.net/?retryWrites=true&w=majority&appName=LinkUp
...
- **GitHub Repository:** [LinkUp](https://github.com/CulmoneY/LinkUp)
- **Maven Installation Guide:** [Install Maven](https://maven.apache.org/install.html)
- **Java JDK Downloads:** [Download JDK](https://www.oracle.com/java/technologies/javase-jdk11-downloads.html)
- **MongoDB Installation:** [Install MongoDB](https://docs.mongodb.com/manual/installation/)
...
- **Google Form:** Please use the following link to submit your feedback: [LinkUp Feedback Form](https://forms.gle/BiMjXZhSeQxSMPNWA)
...
2. **Repository Link:** The project repository is hosted on GitHub: [LinkUp GitHub Repository](https://github.com/CulmoneY/LinkUp).
...
1. **Fork the Repository:**
   - Go to the [LinkUp GitHub Repository](https://github.com/CulmoneY/LinkUp).
...
- If you’re new to contributing, check out GitHub’s guide: [How to Create a Pull Request](https://docs.github.com/en/github/collaborating-with-pull-requests/creating-a-pull-request).
